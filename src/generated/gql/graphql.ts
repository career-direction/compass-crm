...
export function useGetTrainersQuery(
	options?: Omit<Urql.UseQueryArgs<GetTrainersQueryVariables>, "query">,
) {
	return Urql.useQuery<GetTrainersQuery, GetTrainersQueryVariables>({
		query: GetTrainersDocument,
		...options,
	});
}
