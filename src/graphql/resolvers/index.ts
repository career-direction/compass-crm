...
export const resolvers = {
  ...
  ...userResolvers.UserCredentials && { UserCredentials: userResolvers.UserCredentials },
  ...clientResolvers.Client && { Client: clientResolvers.Client },
  ...clientResolvers.ClientProfile && { ClientProfile: clientResolvers.ClientProfile },
  ...trainerResolvers.Trainer && { Trainer: trainerResolvers.Trainer },
  ...trainerResolvers.TrainerProfile && { TrainerProfile: trainerResolvers.TrainerProfile },
  ...sessionResolvers.PTSession && { PTSession: sessionResolvers.PTSession },
  ...sessionResolvers.PTSessionItem && { PTSessionItem: sessionResolvers.PTSessionItem },
};
