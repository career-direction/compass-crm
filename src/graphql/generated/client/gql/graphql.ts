...
export type CreateClientWithProfileMutation = {
	__typename?: "Mutation";
...
export type CreateLearningMaterialMutation = {
	__typename?: "Mutation";
...
export type GetLearningMaterialsQuery = {
	__typename?: "Query";
...
>;
export const CreateClientWithProfileDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "mutation",
			name: { kind: "Name", value: "CreateClientWithProfile" },
			variableDefinitions: [
				{
					kind: "VariableDefinition",
					variable: {
					...
					type: {
						...
						type: {
							kind: "NamedType",
							name: { kind: "Name", value: "CreateClientWithProfileInput" },
						},
					},
				},
			],
								...
								{ kind: "Field", name: { kind: "Name", value: "userId" } },
								{
									...
									selectionSet: {
										...
										selections: [
											...
											{
												kind: "Field",
												name: { kind: "Name", value: "first_name_kana" },
											},
											{
												kind: "Field",
												name: { kind: "Name", value: "last_name_kana" },
											},
											{
												kind: "Field",
								...
								},
								{
									...
									selectionSet: {
										...
										selections: [
											...
											{ kind: "Field", name: { kind: "Name", value: "hobby" } },
											{
												kind: "Field",
												name: { kind: "Name", value: "allowSnsPost" },
											},
											{
												kind: "Field",
												name: { kind: "Name", value: "exerciseHistory" },
											},
										],
									},
								},
	...
	CreateClientWithProfileMutation,
	CreateClientWithProfileMutationVariables
>;
export const CreateLearningMaterialDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "mutation",
			name: { kind: "Name", value: "CreateLearningMaterial" },
			variableDefinitions: [
				{
					kind: "VariableDefinition",
					variable: {
					...
					type: {
						...
						type: {
							kind: "NamedType",
							name: { kind: "Name", value: "CreateLearningMaterialInput" },
						},
					},
				},
			],
	...
	CreateLearningMaterialMutation,
	CreateLearningMaterialMutationVariables
>;
export const GetLearningMaterialsDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "GetLearningMaterials" },
			variableDefinitions: [
				{
					kind: "VariableDefinition",
					variable: {
			...
			selectionSet: {
				...
				selections: [
					{
						kind: "Field",
						name: { kind: "Name", value: "learningMaterials" },
						arguments: [
							{
								kind: "Argument",
								name: { kind: "Name", value: "ownerId" },
	...
	GetLearningMaterialsQuery,
	GetLearningMaterialsQueryVariables
>;
export const GetTrainersDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "GetTrainers" },
			selectionSet: {
				kind: "SelectionSet",
				selections: [
					{
...
} as unknown as DocumentNode<GetTrainersQuery, GetTrainersQueryVariables>;
