...
export type GetClientQuery = { __typename?: 'Query', client?: { __typename?: 'Client', id: number, userId: string, user: { __typename?: 'User', id: number, key: string, first_name: string, last_name: string, first_name_kana: string, last_name_kana: string, birth_date: string, gender: number }, profile?: { __typename?: 'ClientProfile', id: number, occupation: string, hobby: string, allowSnsPost: string, exerciseHistory: string } | null } | null };
