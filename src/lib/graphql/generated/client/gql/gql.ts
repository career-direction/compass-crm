...
type Documents = {
    ...
    "query GetLearningMaterials($limit: Int, $offset: Int) {\n  learningMaterials(limit: $limit, offset: $offset) {\n    id\n    ownerId\n    key\n    name\n    status\n    sourceUrl\n    contentType\n    contentId\n    createdAt\n    updatedAt\n  }\n}": typeof types.GetLearningMaterialsDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query GetLearningMaterials($limit: Int, $offset: Int) {\n  learningMaterials(limit: $limit, offset: $offset) {\n    id\n    ownerId\n    key\n    name\n    status\n    sourceUrl\n    contentType\n    contentId\n    createdAt\n    updatedAt\n  }\n}"): (typeof documents)["query GetLearningMaterials($limit: Int, $offset: Int) {\n  learningMaterials(limit: $limit, offset: $offset) {\n    id\n    ownerId\n    key\n    name\n    status\n    sourceUrl\n    contentType\n    contentId\n    createdAt\n    updatedAt\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
